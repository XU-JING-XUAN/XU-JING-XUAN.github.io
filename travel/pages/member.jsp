							...
							<li class="nav-item active">
								...
								<!--已登入導覽列end-->
									...
									<div class="row" id="center">
										<div class="col-md-12">
											...
											<div class="m-img" style="text-align: center;"><img src="../assets/img/logo.png"></div>
											<div class="mem">
												<h3>
												會員中心
												</h3>
												<img src="../assets/img/northbg.jpg" class="m-img2" >
												<div class="row">
													<div class="col-md-12">
														<form method="post" action="../modify.jsp">
															<div class="input-group mb-3">
																...
																<input type="text" class="form-control" placeholder="帳號" name="username" id="">
															</div>
															<div class="input-group mb-3">
																<div class="input-group-prepend">
																	<span class="input-group-text">密碼：</span>
																</div>
																<input type="password" class="form-control" placeholder="密碼" name="password" id="">
															</div>
															<div class="input-group mb-3">
																<div class="input-group-prepend">
																	<span class="input-group-text">密碼：</span>
																</div>
																<input type="password" class="form-control" placeholder="再次確認密碼" name="password-repect" id="">
															</div>
															<div class="input-group mb-3">
																<div class="input-group-prepend">
																	<span class="input-group-text">姓名：</span>
																</div>
																<input type="text" class="form-control" placeholder="姓名" name="name" id="">
															</div>
															<div class="input-group mb-3">
																<div class="input-group-prepend">
																	<span class="input-group-text">生日：</span>
																</div>
																<input type="text" class="form-control" placeholder="例:2020/5/22" name="birth" id="">
															</div>
															<div class="input-group mb-3">
																<div class="input-group-prepend">
																	<span class="input-group-text">性別：</span>
																</div>
																<input type="text" class="form-control" placeholder="男/女" name="sex" id="">
															</div>
															...
															<div class="input-group mb-3">
																...
																<input type="text" class="form-control" placeholder="手機" name="phone" id="">
															</div>
															<div class="input-group mb-3">
																<div class="input-group-prepend">
																	<span class="input-group-text">地址：</span>
																</div>
																<input type="text" class="form-control" placeholder="地址" name="address" id="">
															</div>
															<div class="input-group mb-3">
																<div class="input-group-prepend">
																	<span class="input-group-text">電子郵件：</span>
																</div>
																<input type="text" class="form-control" placeholder="例:xxx@gmail.com" name="email" id="">
															</div>
															<div class="input-group mb-3">
																<div class="input-group-prepend">
																	消費紀錄:
															...
															<div class="input-group mb-3" id="record">
																<div class="input-group-prepend" id="record-content">
																<div class="co-2">
																	<table>
																		<tr>
																			<th>訂單編號</th>
																		...
																		<%
																			...
																			while(rs.next())
																			{
																			String ornum = rs.getString(1);
																			String proname = rs.getString(9);
																			String prodate = rs.getString(10);
																			String proprice = rs.getString(13);
																			%>

																				<tr style="padding-bottom: 10px">
																					<td style="padding-right: 20px"><%=ornum%></td>
																					<td style="padding-right: 20px"><%=proname%></td>
																					<td style="padding-right: 20px"><%=prodate%></td>
																					<td style="padding-right: 20px"><%=proprice%></td>
																			    </tr>
																		<%}%>
																		<%}%>
																	</table>
															...
															<div class="container-fluid"><!--隱私規範-->
															<div class="row">
																<div class="col-md-12">
																	<h4 style="margin-top: 10px; text-align: center; margin-bottom: 10px; ">
																	Privacy Policy</h4>
																	<div class="co">
																	非常歡迎您光臨Bon Vacances（以下簡稱本網站），為了讓您能夠安心使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：
																	一、隱私權保護政策的適用範圍
															...
															<input class="button2" type="submit" value="確認送出" />
								...
								<footer >
									<div class="row" >
										...
										<font style="color:white ;margin-left:43%;margin-bottom:1%;font-family:'微軟正黑體' ">Copyright &copy;&&nbsp;Bon Vacances  </font>
									</div>
								</footer>
							</div>
						</body>
