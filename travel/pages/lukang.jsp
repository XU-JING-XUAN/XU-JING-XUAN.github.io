							...
							<div class="row" >
								...
								<div class="col-md-6" id="bigpic">
									<div class="carousel slide" id="carousel-63977">
										...
										<%ResultSet rs;%>
									<%
										sql = "select * from product where no = 'lukang'";
									...
									<div class="col-md-6" id="spacing">
										...
										<div class="row"  id="select">
											...
											<div class="col-md-8" id="option">
												<select class="form-control" id="sel1" name="date">
													...
													<option value="2020/06/23"disabled="">2020/06/23</option>
										...
										<div class="row" id="select">
											...
											<div class="col-md-8">
												<select class="form-control" id="sel1" name="tracffic">
								...
								<!--行程介紹end-->
									<div class="parallaxlukang"></div><br>
								<!--行程資訊-->
								<div class="row" >
									<div class="col-md-12" id="introinner">
										<h3 class="goodtitle">
									...
									<div class="row">
										<div class="col-md-12">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="card">
														<a href="tainan.html"><img class="card-img-top" alt="" src="../assets/img/tainan4.jpg" /></a>
														<div class="card-block">
															...
															<p>
																<a class="btn btn-primary" href="tainan.html">see more</a>
															</p>
														</div>
													</div>
												</div>
												<div class="col-md-4">
													<div class="card">
														<a href="north.html"><img class="card-img-top" alt="" src="../assets/img/north5.png" /></a>
														<div class="card-block">
															<h5 class="card-title">
															銀髮族專屬北海岸旅遊
															</h5>
															...
															<p>
																<a class="btn btn-primary" href="north.html">see more</a>
															</p>
														</div>
													</div>
												</div>
												<div class="col-md-4">
													<div class="card">
														<a href="leofoo.html"><img class="card-img-top" alt="" src="../assets/img/leofoo1.jpg" /></a>
														<div class="card-block">
															<h5 class="card-title">
															六福村遊樂世界
															</h5>
															<p class="card-text">
																好像去動物園又好像來點刺激的....那就選擇六福村吧
															</p>
															<p>
																<a class="btn btn-primary" href="leofoo.html">see more</a>
															</p>
														</div>
													</div>
												</div>
