							...
							<div class="row" >
								...
								<div class="col-md-6" id="bigpic">
									<div class="carousel slide" id="carousel-63977">
										...
										<%ResultSet rs;%>
									<%
										sql = "select * from product where no = 'tainan'";
										rs = con.createStatement().executeQuery(sql);
										rs.next();
									%>
											<div class="carousel-item active">
												<img class="d-block w-100" alt="" src="../assets/img/tainan1.jpg" />
												
											</div>
											<div class="carousel-item">
												<img class="d-block w-100" alt="" src="../assets/img/tainan2.jpg" />
												
											</div>
											<div class="carousel-item">
												<img class="d-block w-100" alt="" src="../assets/img/tainan3.jpg" />
												
											</div>
											<div class="carousel-item">
												<img class="d-block w-100" alt="" src="../assets/img/tainan4.jpg" />
												
											</div>
											<div class="carousel-item">
												<img class="d-block w-100" alt="" src="../assets/img/tainan5.jpg" />
								...
								<!--行程介紹end-->
									<div class="parallaxtainan"></div><br>
								<!--行程資訊-->
								<div class="row" >
									<div class="col-md-12" id="introinner">
										<h3 class="goodtitle">
									...
									<div class="row">
										<div class="col-md-12">
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="card">
														<a href="eda.html"> <img class="card-img-top" alt="" src="../assets/img/eda4.jpg" /></a>
														<div class="card-block">
															<h5 class="card-title">
															義大遊樂世界
															</h5>
												...
												<div class="col-md-4">
													<div class="card">
														<a href="north.html"><img class="card-img-top" alt="" src="../assets/img/north3.jpg" /></a>
														<div class="card-block">
															<h5 class="card-title">
															北海岸一日遊
															</h5>
