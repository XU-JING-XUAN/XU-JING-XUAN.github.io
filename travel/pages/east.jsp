...
<html>
	<head>
		...
		<title>花東縱谷欣賞臺灣獨特壯麗風景，讚嘆自然之美</title>
		<style>
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						...
						<ul class="navbar-nav ml-md-auto">
							...
							<div class="row" >
								...
								<%ResultSet rs;%>
									<%
										sql = "select * from product where no = 'east'";
									...
									<div class="carousel slide" id="carousel-63977">
										...
										<div class="carousel-inner">
											...
											<div class="carousel-item">
												<img class="d-block w-100" alt="" src="../assets/img/<%=rs.getString(2)%>t3.jpg" />
									...
									<div class="row">
										<div class="col-md-12">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="card">
														<a href="eda.html"><img class="card-img-top" alt="" src="../assets/img/eda2.jpg" /></a>
												...
												<div class="col-md-4">
													<div class="card">
														<a href="tainan.html"><img class="card-img-top" alt="" src="../assets/img/tainan3.jpg" /></a>
														<div class="card-block">
															<h5 class="card-title">
															臺南鹽鄉體驗
															</h5>
