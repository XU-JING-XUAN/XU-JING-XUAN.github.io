					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						...
						<ul class="navbar-nav ml-md-auto">
							...
							<div class="row" >
								...
								<%ResultSet rs;%>
									<%
										sql = "select * from product where no = 'leofoo'";
								...
								<!--行程介紹end-->
									<div class="parallaxleofoo"></div><br>
								<!--行程資訊-->
								<div class="row" >
									<div class="col-md-12" id="introinner">
										<h3 class="goodtitle">
									...
									<div class="row">
										<div class="col-md-12">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="card">
														<a href="tainan.html"><img class="card-img-top" alt="" src="../assets/img/tainan1.jpg" /></a>
												...
												<div class="col-md-4">
													<div class="card">
														<a href="north.html"><img class="card-img-top" alt="" src="../assets/img/north1.jpg" /></a>
														<div class="card-block">
															<h5 class="card-title">
															北海岸一日遊
															</h5>
